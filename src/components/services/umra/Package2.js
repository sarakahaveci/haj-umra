...
const Package2 = () => {
  return (
    <div>
      ...
      <h2>Umre ve Edâ Şekli</h2>
      <p>
        Umre: Lügatte, mamur bir yeri ziyarete niyet ve azm etmek manasındadır.
      </p>
      <p>
        Fıkıhçılar lisanında ise; Kabe-i Muazzama’yı ziyaret ve tavaf ile Safa
        ve Merve arasını say ederek yapılan ibadetin adıdır.
      </p>
      <p>
        Umre, sünneti müekkededir. Hac şartlarını taşıyan kimseler için vacip
        olduğunu söyleyen alimlerin sayısı da az değildir.
      </p>
      <p>
        Belli bir zamanı yoktur. Senenin her mevsiminde yapılabilir. Ancak Arafa
        ve Kurban bayramının dört gününde yapılması mekruhtur.
      </p>
      <p>Ramazan-ı şerif’te yapılması daha faziletlidir.</p>
      <p>
        Ebu Hureyre (ra) rivayet ediyor. Rasulullah (sav) Efendimiz buyurdular
        ki :
      </p>
      <p>
        ((الْعُمْـرَةُ إِلىَ الْعُمْـرَةِ كَفّاَرَةٌ لِماَ بَيْنَهُماَ، وَ
        الْحَجُّ الْمَبْـرُورُ لَيْسَ لَـهُ جَزاَءٌ إِلاَّ الْجَنَّةـ
      </p>
      <p>
        "Umre, bir sonraki umre ile arasındakilere kefarettir. İhlasla edâ
        edilen, riya ve masiyetten uzak bir haccın karşılığı şüphesiz
        cennettir." (Muttefekun Aleyh)
      </p>
      <p>
        İbn-i Abbas (ra) rivayet ediyor: Rasulullah (sav) Efendimiz ensar
        hanımlarından Ümmü Sinan’a buyurdular ki ((فَإِذاَ جاَءَ رَمَضَانُ
        فاَعْتَمِرِى. فَإِنَّ عُمْرَةً فِيهِ تَعْدِلُ حَجَّةً.))
      </p>
      <p>
        “Ramazan gelince umre yap ! Onda yapılacak umrenin sevabı hac sevabına
        müsavidir.” (Müttefekun Aleyh)
      </p>
      <h2>UMRE'NİN EDÂ ŞEKLİ:</h2>
      <p>
        Umre yapmak için Beytullah’a yönelen, gözünü gönlünü Kabe’nin yanında
        dinlendirmek, huzura kavuşturmak, hak yolda yepyeni bir azimle dolmak
        isteyen kardeşimiz! İslâm nûrunun ilk yayılmaya başladığı, nice
        hatıraların yaşandığı beldelere varma, Allah Rasûlü’nü ziyaret şevki
        taşıdığınız, bu yolculuk için kalplerinizi hazırladığınız,
        yumuşattığınız gibi ;
      </p>
      <h2>İhrama Girmeden Önce:</h2>
      <p>* Gerekli vücut temizliğini yapınız. Mümkünse güzel koku sürününüz.</p>
      <p>
        Hanımların diğer zamanlarda olduğu gibi evlerinin haricinde başkaları
        tarafından hissedilecek kokular sürmelerinde mahzur vardır.
      </p>
      <p>
        * Sıhhî tedbirlerinizi alınız. İhram yasağına uygun elbiselerinizi
        giyiniz.
      </p>
      <p>
        Erkekler giymekte oldukları bütün elbiselerini soyunur, sadece “izar” ve
        “rida” denilen iki parça örtüye bürünürler.
      </p>
      <p>
        İzar, bele bağlanan ve belden aşağısını örten parçaya, ridâ ise omuza
        alınan ve üstü örten parçaya denir.
      </p>
      <p>
        Bu iki örtünün beyaz, yeni ve temiz olması müstehaptır. Ayrıca azaları
        belli etmeyecek şekilde kalınca olmalıdır.
      </p>
      <p>
        Ayaklarına terlik giyerler. Terlik bulamamışlarsa, ayakkabılarını
        topuklarını örtmeyecek hale getirirler.
      </p>
      <p>
        Kadınlar elbiselerini çıkartmazlar. Onlar için daima tesettüre en uygun
        olan, daha münasip olandır. Ancak, hanımlar yüzlerini, arada boşluk
        kalmayacak şekilde, yüzlerine değen bir şeyle örtmezler. Ayakkabı, çorap
        giyerler, eldiven giyebilirler.
      </p>
      <h2>İhrama Girerken:</h2>
      <p>
        Bu hazırlıklardan sonra, mikat sınırında veya daha önce:
        <br />
        * İhramın sünneti olarak –kerahet vakti değil ise– iki rekat namaz
        kılınız.
        <br />
      ...
      <p>
        للَّهُمَّ إِنِّى أُرِيدُ الْعُمْـرَةَ لِوَجْهِكَ الْكَرِيمِ فَيَسِّرْهاَ
        لِى وَ تَقَبَّلْهاَ مِنِّى. نَوَيْتُ الْعُمْـرَةَ وَ أَحْرَمْتُ بِهاَ
        ِللهِ تَعـاَلىَ.
      </p>
      <p>
        “Allah’ım senin rızan için umre edâ etmek istiyorum. Onun edâsını bana
        kolay kıl ve umremi kabul buyur. Allah rızası için umreye niyet ettim ve
        ihrama girdim.”
      </p>
      <p>
      ...
      <h2>Telbiye :</h2>
      <p>
        لَبَّيْكَ اَللَّهُمَّ لَبَّيْكَ. لَبَّيْكَ لاَ شَرِيكَ لَكَ لَبَّيْكَ.
        إِنَّ الْحَمْدَ وَ النِّعْمَةَ لَكَ وَ الْمُلْكَ لاَ شَرِيكَ لَكَ.
      </p>
      <p>
        "Lebbeyk Allahümme lebbeyk. Lebbeyke lâ şerîke leke lebbeyk. İnnel hamde
        ven niğmete leke velmülk lâ şerîke lek.” “Allah’ım! Senin emr-i celiline
        her an koşmaya, her an itaata hazırım. Sana ortak yoktur. Emir ve
        davetine, gönülden ve sadakatle icabet ederim. Şüphesiz ki; hamd de,
      ...
      <p>
        * Niyet edip telbiye getirince artık ihramlı sayılırsınız. Bu andan
        ...
        <br />
        * Yol boyunca bilhassa tepelere yükseldikçe, vadilere indikçe, yeni bir
        grupla karşılaştıkça, konaklayıp hareket ettikçe, yeni bir mıntıkaya,
        şehre gittikçe telbiye getiriniz.
        <br />
